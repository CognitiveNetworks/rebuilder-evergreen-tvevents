# Demo App Helm Chart
Chart to deploy demo-app.

## Description
Helm chart for deploying a demo-app in Kubernetes environments.
...
# Secrets Management
secretKey: dev/app/application-secrets
secretStore: demo-app-secret-store
