...
- **Cache:** File-based cache (/tmp/.blacklisted_channel_ids_cache) — no Redis
- **Additional:** Apache Kafka (AWS MSK), OpenTelemetry auto-instrumentation
