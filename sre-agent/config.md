...
|---|---|---|---|---|
| tvevents-k8s | *[TODO: URL after infra provisioning]* | dev | yes | TV event ingestion service |
| tvevents-k8s | *[TODO: URL after infra provisioning]* | staging | yes | TV event ingestion service |
| tvevents-k8s | *[TODO: URL after infra provisioning]* | prod | yes | TV event ingestion service |
...
- **Database networking:** Private IP only (VPC)
- **Additional Services:** Apache Kafka (AWS MSK), OpenTelemetry auto-instrumentation
...
|---|---|---|---|---|
| tvevents-k8s | 99.9% | 500ms | 0.1% | 43.2 min/month |
...
|---|---|---|---|---|
| tvevents-k8s | 100 | 200 | cloud_native | CPU-based HPA at 70% threshold |
